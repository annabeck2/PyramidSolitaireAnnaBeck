...
/**
 * Test class for Relaxed Pyramid Solitaire.
 */
public class RelaxedPyramidSolitaireTest {

  RelaxedPyramidSolitaire game1 = new RelaxedPyramidSolitaire();
  ...
  @Test
  public void removeRelaxedOneCard() {
    game1.startGame(game1.getDeck(), false, 4, 8);
    game1.removeUsingDraw(6,3,2);
    game1.remove(3,1,2,1);
    assertEquals(null, game1.getCardAt(3,1));
  ...
  public void testLosingGame() {
    ...
    game1.removeUsingDraw(2, 2,0);
    game1.removeUsingDraw(3, 1,1);
    game1.removeUsingDraw(4, 1,0);
    game1.removeUsingDraw(5,0,0);
    System.out.println(game1.isGameOver());
