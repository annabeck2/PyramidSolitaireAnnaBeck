...
/**
 * Test class for multipyramid solitaire.
 */
public class MultiPyramidSolitaireTest {
  MultiPyramidSolitaire game1 = new MultiPyramidSolitaire();

  @Test
  public void printPyrTest() {
    game1.startGame(game1.getDeck(), false, 6, 4);
    assertEquals(6, game1.getNumRows());
  }
  ...
  public void testRemoveMore() {
    game1.startGame(game1.getDeck(), false, 7, 2);
    game1.remove(6, 1, 6, 12);
    assertEquals(null, game1.getCardAt(6,1));
    assertEquals(null, game1.getCardAt(6,12));
  }
  ...
  public void testRemove1ThirteenOneCard() {
    ...
    game1.remove(4, 1);
    assertEquals(null, game1.getCardAt(4,1));
  }
  ...
  public void testRemoveUsingDrawValid2() {
    game1.startGame(game1.getDeck(), false, 7, 3);
    game1.removeUsingDraw(2, 6, 11);
    assertEquals(null, game1.getCardAt(6,11));
  }
  ...
  public void testRemoveUsingDraw() {
    game1.startGame(game1.getDeck(), false, 4, 6);
    game1.remove(3, 1, 3, 4);
    game1.removeUsingDraw(3,3,7);
    assertEquals(null, game1.getCardAt(3,4));
  }
  ...
  public void testGetScore() {
    game1.startGame(game1.getDeck(), false, 7, 1);
    game1.getScore();
    assertEquals(game1.getScore(), 442);
  }
  ...
  public void testGetRowWidth() {
    ...
    assertEquals(13, game1.getRowWidth(6));
  }
  ...
  public void testDealCorrectlyNoShuffle() {
    ...
    assertEquals(8, game1.getRowWidth(3));
  }
  ...
  public void isGOver1() {
    game1.startGame(game1.getDeck(), false, 3, 4);
    game1.removeUsingDraw(2,2,3);
    game1.removeUsingDraw(3,2,2);
    game1.removeUsingDraw(1,2,4);
    assertEquals(false, game1.isGameOver());
  }
  ...
  public void testInvRowDraw() {
    game1.startGame(game1.getDeck(), true, 3, 483);
  }
